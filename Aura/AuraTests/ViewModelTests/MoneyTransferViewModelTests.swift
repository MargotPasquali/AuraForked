...
// MARK: - MoneyTransferViewModelTests

/// Tests unitaires pour `MoneyTransferViewModel`.
///
/// Cette classe de tests vérifie les différentes fonctionnalités du `MoneyTransferViewModel`, telles que la validation des champs, l'envoi d'argent, et la gestion des erreurs.
final class MoneyTransferViewModelTests: XCTestCase {
    ...
    /// Teste l'envoi d'argent avec des champs vides.
    func testSendMoneyWithEmptyFields() async throws {
        ...
        do {
            ...
            // Ajoute un délai pour que l'interface se mette à jour
    ...
    /// Teste l'envoi d'argent avec un destinataire invalide.
    ...
    /// Teste un transfert d'argent réussi.
    ...
    /// Teste un échec de transfert d'argent dû à une erreur de service.
